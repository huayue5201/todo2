...
function M.build(ctx)
	...
	local test_framework = "使用语言的标准测试框架"

	if lang == "go" then
		test_framework = "使用 testing 包，测试函数以 Test 开头"
	elseif lang == "python" then
		test_framework = "使用 pytest 或 unittest，测试函数以 test_ 开头"
	elseif lang == "javascript" or lang == "typescript" then
		test_framework = "使用 Jest / Mocha，使用 describe/it 结构"
